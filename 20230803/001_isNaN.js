...
// isNaN()은 내부적으로 Number() 함수를 사용합니다.
// Number() 함수는 인수를 숫자로 변환할 수 없으면 NaN을 반환합니다.
// 암기할것!!!: isNaN()은 Number로 숫자변환이 가능한 값을 false로 준다!
// 암기할것!!!(실무에서 많이쓰임): !isNaN(value[0]) -> 숫자를 걸러내는방법
